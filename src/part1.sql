...
CALL import_table(name_table:='Date_of_Analysis', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Date_Of_Analysis_Formation.tsv', separ:='\t');
CALL import_table(name_table:='Personal_Information', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Personal_Data_Mini.tsv', separ:='\t');
CALL import_table(name_table:='Cards', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Cards_Mini.tsv', separ:='\t');
CALL import_table(name_table:='Transactions', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Transactions_Mini.tsv', separ:='\t');
CALL import_table(name_table:='SKU_Group', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Groups_SKU_Mini.tsv', separ:='\t');
CALL import_table(name_table:='Product_Grid', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/SKU_Mini.tsv', separ:='\t');
CALL import_table(name_table:='Stores', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Stores_Mini.tsv', separ:='\t');
CALL import_table(name_table:='Checks', file_path:='/home/ipakin/SQL3_RetailAnalitycs_v1.0-1/datasets/Checks_Mini.tsv', separ:='\t');

-- ДЛЯ MAC
-- CALL import_table(name_table:='Date_of_Analysis', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Date_Of_Analysis_Formation.tsv', separ:='\t');
-- CALL import_table(name_table:='Personal_Information', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Personal_Data_Mini.tsv', separ:='\t');
-- CALL import_table(name_table:='Cards', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Cards_Mini.tsv', separ:='\t');
-- CALL import_table(name_table:='Transactions', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Transactions_Mini.tsv', separ:='\t');
-- CALL import_table(name_table:='SKU_Group', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Groups_SKU_Mini.tsv', separ:='\t');
-- CALL import_table(name_table:='Product_Grid', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/SKU_Mini.tsv', separ:='\t');
-- CALL import_table(name_table:='Stores', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Stores_Mini.tsv', separ:='\t');
-- CALL import_table(name_table:='Checks', file_path:='/Users/steffani/SQL3_RetailAnalitycs_v1.0-1/src/datasets/Checks_Mini.tsv', separ:='\t');
